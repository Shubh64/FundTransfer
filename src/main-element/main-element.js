          ...
          <app-header-layout has-scrolling-region>
            <app-header class="main-header" slot="header">
              <app-toolbar class="heading">
                ...
                <span class="heading-title">Fund Transfer</span>
              ...
              <iron-pages selected="[[page]]" attr-for-selected="name" role="main" fallback-selection="error404">
                <transaction-details id="transaction-details" name="transaction-details"></transaction-details>
                <login-page name="login"></login-page>
                <user-home name="user-home"></user-home>
                <make-transaction name="make-transaction"></make-transaction>
                <beneficiary-details id="beneficiary-details" name="beneficiary-details"></beneficiary-details>
         ...
         _pageChanged(newPage) {
          ...
          switch (newPage) {
            case 'login': import('./login-page.js')
              break;
              case 'beneficiary-details': import('./beneficiary-details.js')
              break;
              case 'transaction-details': import('./transaction-details.js')
              break;
              case 'user-home': import('./user-home.js')
              break;
              case 'make-transaction': import('./make-transaction.js')
              break;
